...
function boost_wrapper(wid::Cint,klocal::Cint,kglobal::Cint,gprev_b::Ptr{Cdouble},gprev_e::Ptr{Cdouble},gcurr_b::Ptr{Cdouble},boost_data::Ptr{Void})
...
const boosting_c = cfunction(boost_wrapper, Ptr{Cdouble},
                             (Cint, Cint, Cint, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Void}))
